...
This project analyzes e-commerce transaction data using statistical
distribution modeling and transformation techniques.
...
The dataset contains 1000 transaction records including:
